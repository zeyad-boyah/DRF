...
# this is for the mixins
urlpatterns = [
    path(
        "<int:pk>/",
        views.ProductListCreateDetailMixin.as_view(),
        name="detail view with primary key",
    ),
    path(
        "<int:pk>/update/",
        views.ProductUpdateMixin.as_view(),
        name="update a product with primary key",
    ),
    path(
        "<int:pk>/delete/",
        views.ProductDeleteMixin.as_view(),
        name="delete a product with primary key",
    ),
    path(
        "",
        views.ProductListCreateDetailMixin.as_view(),
        name="list all or Create a new instance of product",
    ),
]


"""
this is for the normal APIViews
urlpatterns = [
